...
class Database
{
  public:
    ...
    ups_status_t flush();
    ups_status_t insert(Transaction *txn, ups_key_t *key, ups_record_t *record, unsigned long long *lht, unsigned long long *elapsed);
    ups_status_t erase(Transaction *txn, ups_key_t *key);
    ups_status_t find(Transaction *txn, ups_key_t *key, ups_record_t *record, unsigned long long *lht, unsigned long long *elapsed);
  ...
  protected:
    ...
    virtual ups_status_t do_insert(Transaction *txn, ups_key_t *key,
                    ups_record_t *record, unsigned long long *lht, unsigned long long *elapsed) = 0;
